...
cfg.merge_from_file('output/CenterNet2/CenterNet2_R2-101-DCN-BiFPN_4x+4x_1560_ST(nms0.7test)/config.yaml')
...
# cfg.MODEL.WEIGHTS = os.path.join(cfg.OUTPUT_DIR, 'CenterNet2', 'CenterNet2_R2-101-DCN-BiFPN_4x+4x_1560_ST(nms0.7)', 'model_0016199.pth')
